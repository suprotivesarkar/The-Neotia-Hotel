...
.faclist li{display:inline-block;background:#5e03a2f5;margin:1px 2px;padding: 2px 6px;border-radius:24px;color:#fff;font-weight:600}
...
<li class="nav-item"><a class="nav-link active" href="reservation-checkout">Check-Out (<?php echo $checkout; ?>)</a></li>
...
var table =$('#entry_table').DataTable({
  ...
  "pageLength": 25,
  "aaSorting":[[0,"desc"]],
  "oLanguage":{sProcessing:"<img class='reloadimg' src='assets/img/spiner.gif'>","sEmptyTable": "Sorry..No Check-Out Found"},
  ...
  "ajax":{
    ...
    type:"post",
    data:{"operation":"fetchout","sdate":$("#sdate").val(),"edate":$("#edate").val()},
