...
<li class="nav-item"><a class="nav-link active" href="reservation-cancel">Cancel(<?php echo $cancel; ?>)</a></li>
</ul>
<div class="row">
<div class="col-xl-12">
<div class="card card-statistics h-100">
<div class="card-title"><h5>Cancel Reservations</h5>
</div>
<div class="card-body">
...
var table =$('#entry_table').DataTable({
  ...
  "ajax":{
    url :"helper/master/reservation-cancel-data", 
    type:"post",
