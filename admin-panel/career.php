...
$.post("helper/master/_career",{"operation":"viewmorecare","id":button.data("id")},function(data){
$(".enqfull").html(data);
});
});
...
function fetchData(){$.post("helper/master/_career",{"operation":"fetchcareer"},function(data){$(".loadpan").html(data);$('#entry_table').DataTable({stateSave:true});});}
</script>
</body>
</html>