...
<h5>Room Facility<a href="" data-toggle="modal" data-target="#addMod" class="button x-small pull-right"><i class="fa fa-plus"></i> Add New</a></h5>
</div>
<div class="card-body">
...
<div class="modal-title"><h4>Add New Facility</h4></div>
...
<div class="modal-content">
<div class="modal-header">
<div class="modal-title"><h4>Update Facility</h4></div>
<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
</div>
<div class="modal-body">
...
e.preventDefault();
if($("#addfrm").valid()){
    var url="helper/master/room_facility";
...
function fetchData(){
  $.ajax({
    type: "POST",
    url: "helper/master/room_facility",
